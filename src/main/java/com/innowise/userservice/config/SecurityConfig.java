                ...
                .authorizeHttpRequests(requests ->
                        requests
                                ...
                                .requestMatchers(HttpMethod.GET, "/api/cards")
                                    .hasRole("admin")
                                .requestMatchers(HttpMethod.PATCH, "/api/cards/{userId}/{id}")
                                    .hasRole("admin")
                                .requestMatchers(HttpMethod.PATCH, "/api/cards/{userId}/{id}/activate")
                                    .hasRole("admin")
                                .requestMatchers(HttpMethod.PATCH, "/api/cards/{userId}/{id}/deactivate")
                                    .hasRole("admin")
